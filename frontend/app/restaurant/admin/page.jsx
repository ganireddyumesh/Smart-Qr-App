    ...
    return (
        <div className="min-h-screen bg-gray-50 font-sans flex flex-col">
            ...
            <div className="bg-gradient-to-r from-orange-500 to-red-500 p-6 pt-10 pb-8 rounded-b-[2rem] shadow-xl text-white">
                ...
                <p className="text-orange-100">Manage your restaurant efficiently.</p>
            </div>
                ...
                <Link href="/restaurant/menu">
                    <div className="bg-white p-6 rounded-2xl shadow-md border border-gray-100 flex items-center gap-4 hover:shadow-lg transition active:scale-95 cursor-pointer">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">Edit items, prices & active status</p>
                        </div>
                    </div>
                </Link>

                <Link href="/restaurant/admin/accounts">
                    <div className="bg-white p-6 rounded-2xl shadow-md border border-gray-100 flex items-center gap-4 hover:shadow-lg transition active:scale-95 cursor-pointer">
                        <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center text-3xl">
                            👥
                        </div>
                        <div>
                            <h2 className="text-xl font-bold text-gray-800">Manage Accounts</h2>
                            <p className="text-sm text-gray-500">Staff access & passwords</p>
                        </div>
                    </div>
                </Link>
